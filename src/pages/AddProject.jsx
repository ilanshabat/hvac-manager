...
export default function AddProject({ user, onBack, onSaved }) {
  ...
  const s = {
    ...
    saveBtn: (loading) => ({ width:'100%', padding:'14px', background: loading ? '#9B9280' : '#2D4A3E', border:'none', borderRadius:'14px', color:'#fff', fontSize:'15px', fontWeight:'600', cursor: loading ? 'default' : 'pointer', fontFamily:'Heebo, sans-serif' }),
  }
